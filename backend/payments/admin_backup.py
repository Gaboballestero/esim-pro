...
class OrderAdmin(admin.ModelAdmin):
    ...
    actions = ['mark_completed', 'mark_cancelled', 'generate_invoice']
...
class PaymentAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'transaction_id_short', 'order_number', 'payment_method_display',
    ...
    readonly_fields = (
        'transaction_id', 'provider_transaction_id', 'created_at', 
        'processed_at', 'payment_details'
    )
    raw_id_fields = ('order',)
    date_hierarchy = 'created_at'
    ...
    fieldsets = (
        ...
        ('Información del Proveedor', {
            'fields': ('provider_transaction_id', 'payment_details'),
            'classes': ('collapse',)
        }),
        ('Fechas', {
    ...
    def transaction_id_short(self, obj):
        """Transaction ID abreviado"""
        return f"{obj.transaction_id[:8]}...{obj.transaction_id[-4:]}"
    ...
    mark_failed.short_description = 'Marcar como fallidos'
