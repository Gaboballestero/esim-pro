...
const ESIMGuideScreen = ({ navigation, route }: any) => {
  ...
  const guideSteps: GuideStep[] = [
    ...
    {
      id: 'apn-config',
      title: 'Configurar APN (si es necesario)',
      description: 'Configuración manual de red',
      icon: 'settings',
      details: [
        'La mayoría de eSIMs se configuran automáticamente',
        'Si no tienes internet, configura manualmente:',
        currentPlatform === 'ios' 
          ? 'iOS: Configuración > Celular > Red de datos móviles'
          : 'Android: Configuración > Conexiones > Redes móviles > APN',
        'APN: internet.com (consulta tu email de compra)',
        'Usuario y Contraseña: generalmente vacíos',
        'Reinicia el dispositivo después de configurar',
      ],
      platform: 'both',
    },
    {
  ...
  const openQRCode = () => {
    if (esim?.qr_code) {
      ...
      Alert.alert(
        'Código QR',
        'Tu código QR se enviará por email después de la compra.\n\nTambién puedes encontrarlo en la sección "Mis eSIMs".',
        [{ text: 'Entendido' }]
      );
    }
  };
  ...
  const openSettings = () => {
    if (Platform.OS === 'ios') {
      ...
      // Android - abrir configuración de red móvil
  ...
  const contactSupport = () => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Chat en vivo', onPress: () => navigation.navigate('ChatSupport') },
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.platformToggle}>
        ...
        >
          <Ionicons 
            name="logo-apple" 
            size={20} 
            color={currentPlatform === 'ios' ? COLORS.surface : COLORS.textSecondary} 
          />
          <Text style={[
            styles.platformText,
        ...
        >
          <Ionicons 
            name="logo-android" 
            size={20} 
            color={currentPlatform === 'android' ? COLORS.surface : COLORS.textSecondary} 
          />
          <Text style={[
            styles.platformText,
      ...
      <View style={styles.quickActions}>
        <TouchableOpacity style={styles.quickActionButton} onPress={openQRCode}>
...
export default ESIMGuideScreen;
