...
type SupportScreenNavigationProp = StackNavigationProp<RootStackParamList>;
  ...
  const renderChatTab = () => (
    <View style={styles.tabContent}>
      ...
      <View style={styles.chatComingSoon}>
        ...
        <Text style={styles.comingSoonTitle}>Chat en Vivo Disponible</Text>
        <Text style={styles.comingSoonText}>
          Conecta con nuestro equipo de soporte las 24 horas del día.
          Respuestas instantáneas y asistencia personalizada.
        </Text>
        <TouchableOpacity 
        ...
        >
          ...
          <Text style={styles.whatsappButtonText}>Iniciar Chat</Text>
        </TouchableOpacity>
